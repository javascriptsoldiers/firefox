package automationBed_Google.utility.fileDownloadManager;
...
public class FileDownloader {
	...
	// private static final Logger LOG = Logger.getLogger(FileDownloader.class);
	    ...
	    private String downloader(WebElement element, String attribute) throws IOException, NullPointerException, URISyntaxException {
	        ...
	        System.err.println("Mimic WebDriver cookie state: " + this.mimicWebDriverCookieState);
	        ...
	        System.err.println("Sending GET request for: " + httpget.getURI());
	        HttpResponse response = client.execute(httpget, localContext);
	        this.httpStatusOfLastDownloadAttempt = response.getStatusLine().getStatusCode();
	        System.err.println("HTTP GET request status: " + this.httpStatusOfLastDownloadAttempt);
	        System.err.println("Downloading file: " + downloadedFile.getName());
	       // FileUtils.copyInputStreamToFile(response.getEntity().getContent(), downloadedFile);
	        response.getEntity().getContent().close();
	 
	        String downloadedFileAbsolutePath = downloadedFile.getAbsolutePath();
	        System.err.println("File downloaded to '" + downloadedFileAbsolutePath + "'");
