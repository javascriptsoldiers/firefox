...
public class CallSideBarArchiveTab extends SuiteBase {

	public void archiveInitiateCallbyEnteringPhoneNumber(String email, String password, String data) throws Exception 
	{
	...
	public void archiveInitiateCallbySelectingFromSuggestions(String email, String password, String data) throws Exception 
	{
		...
		//callPage.EnteraNameOrNum().enterContactLetter("t").callplaced().verifyAbleToMakeCall();
		callPage.EnteraNameOrNum().enterContactLetter("t");
		homePage.verifyContactListDisplayed();
		callPage.callplaced().clickOnCallEndBtn();
	}
	public void switchToTheSettingsArchiveTab(String email, String password, String data) throws Exception 
	{
		Utils.uBase.launchWebApplication();
		...
		hmPage.clickMainMenu().clickArchive().clickSettings();
		homePage.verifyNavigatedToSettings().verifyDailpadNotDisplayed();
		stngpg.clickCloseSettings();
		homePage.verifyNavigatedToArchive();
		homePage.verifyCallPanelInRight();
	}

	public void initiateCallFromArchiveDetailsBar(String email, String password, String data) throws Exception {
